...
import 'package:gs_ur_dart/src/registry/gs_basic_chain/gs_sign_request.dart';
...
class GsWalletChainSDK{
  static Map<String, dynamic> parseSignature(UR ur) {
    if (ur.type != ExtendedRegistryType.GS_SIGNATURE.type) {
      throw ArgumentError('type not match');
    }
    final sig = GsSignature.fromCBOR(ur.cbor);
